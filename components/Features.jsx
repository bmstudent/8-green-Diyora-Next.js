function Features() {
  return (
    <>
      <section className="py-12 bg-gray-900 text-gray-100 sm:py-12 lg:py-16 w-full">
      ...
      <section
        id="features"
        className="container mx-auto px-4 space-y-6 dark:bg-gray-900 py-8 md:py-12 lg:py-20"
      >
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          <div className="relative overflow-hidden rounded-lg border-gray- bg-gray-500 select-none hover:shadow hover:shadow-white p-2">
          ...
          <div className="relative bg-gray-500 overflow-hidden rounded-lg border-gray-500 select-none hover:shadow hover:shadow-white p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current">
