function Footer() {
  return (
    <>
      <section className="pt-16 pb-7 bg-gray-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-12 pb-12 border-b-2 border-gray-700 max-lg:gap-7">
            <div className="col-span-12 lg:col-span-7">
              <h2 className="font-manrope font-bold text-3xl leading-tight text-white mb-2 max-lg:text-center">
          ...
          <div className="pt-7 flex flex-col min-[500px]:flex-row items-center justify-between ">
            <a href="https://pagedone.io/" className="px-0.5 py-1.5">
              ...
              >
                ...
                <path
                  ...
                  fill="url(#paint0_linear_551_348)"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  ...
                  fill="url(#paint1_linear_551_348)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_551_348"
                    x1="0"
                    y1="33"
                    x2="40.8853"
                    y2="10.8759"
